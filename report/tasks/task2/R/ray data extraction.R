...
where a.fldMainSpeciesCode = 'THR'
...
where f.FISHLATINNAME = 'Raja clavata'
...
where a.[cruise code] not like 'eco%'
   and f.[Weight] > 0 
   and g.[Scientific Name] = 'Raja clavata'
"
...
where b.CATCHTYPEID = 1
   ...
   and f.FISHLATINNAME = 'Raja clavata'
