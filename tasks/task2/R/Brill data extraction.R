...
where a.fldMainSpeciesCode = 'BLL'
...
where f.FISHLATINNAME like 'Scophthalmus %'
...
where a.[cruise code] not like 'eco%'
   and f.[Weight] > 0 
   and g.[Scientific Name] like 'Scophthalmus %'
"
...
where b.CATCHTYPEID = 1
   ...
   and f.FISHLATINNAME like 'Scophthalmus %'
