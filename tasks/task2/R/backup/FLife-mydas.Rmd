...
```{r, data}
lhpmydas=read.csv(file.path(dirInp,"lifehistories.csv"))
```
...
ggpairs(transform(lhpmydas[,c(2:6,8)],linf=log(linf),k=log(k),l50=log(l50)),
  mapping = ggplot2::aes(color=area),
