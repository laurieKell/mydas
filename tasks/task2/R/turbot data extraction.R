...
where a.fldMainSpeciesCode = 'TUR'
...
where f.FISHLATINNAME like 'Psetta %'
...
where a.[cruise code] not like 'eco%'
   and f.[Weight] > 0 
   and g.[Scientific Name] like 'Psetta %'
"
...
where b.CATCHTYPEID = 1
   ...
   and f.FISHLATINNAME like 'Psetta %'
...
save(bio,len,file='turbot.RData')
