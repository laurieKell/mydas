...
```{r}
ggplot(subset(mnl,speciesgp%in%c("BLL","TUR")))+
...
mlz(as.FLQuant(subset(mnl,speciesgp=="BLL")[,2:3]),FLPar(aaply(prior,1,mean)))
```
...
### MLZ
```{r, turbot-mlz}
mlz(as.FLQuant(subset(mnl,speciesgp=="TUR")[,2:3]),FLPar(aaply(prior,1,mean)))
```
