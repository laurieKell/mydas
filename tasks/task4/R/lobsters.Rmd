...
lh=read.csv("/home/laurence/Desktop/sea++/mydas/project/tasks/task4/inputs/lobsterGrw.csv")
...
lh=cbind(lh,cbind(a50=c( 6.0,rep(NA,dim(lh)[1]-1)),
                  l50=c(77.5/10,rep(NA,dim(lh)[1]-1)),
...
#gTime=4 #round(FLife:::genTime(FLPar(aaply(lh,1,mean))))
