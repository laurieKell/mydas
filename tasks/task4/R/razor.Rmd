...
lh=read.csv("/home/laurence/Desktop/sea++/mydas/project/tasks/task4/inputs/razorGrowth.csv")[,1:3]
lh[,1]=lh[,1]/10
lh=cbind(lh,l50=c(lhist["l50"],rep(NA,dim(lh)[1]-1)))
...
```{r}
save(lh,eq,file=file.path(dirDat,"razor.RData"),compress="xz")    
```
...
gTime=round(mean(mean(genTime(eq))))
