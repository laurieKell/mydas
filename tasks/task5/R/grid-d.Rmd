...
pollack=FLStocks(llply(pollack,window,end=103))
plot(pollack)
```

**Figure `r iFig=iFig+1; iFig`** Time series for polack of empirical HCR ran with different values of K1 & K2
...
ray=FLStocks(llply(ray,window,end=99))
plot(ray)
```
